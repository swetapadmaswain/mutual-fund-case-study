...
MOCK_RESPONSES = {
    ...
    "What is the minimum investment amount for HDFC funds?": {
        ...
        "answer": "The minimum investment amount for HDFC mutual funds varies by scheme. For lumpsum investment, it's typically ₹500 for most equity funds and ₹1,000 for debt funds. For SIP, the minimum is ₹500 per month across all schemes.",
    ...
    try:
        ...
        if phase3_pipeline:
            try:
                ...
                print(f"⚠️ Phase 3 fallback to mock: {e}")
