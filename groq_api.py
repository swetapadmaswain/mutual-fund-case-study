"""
Groq-Powered Backend API for Mutual Fund FAQ Assistant
Uses Groq LLM for intelligent response generation with compliance enforcement
"""
...
def health_check():
    ...
    return jsonify({
        ...
        'timestamp': datetime.now().isoformat(),
        'version': 'v3',
        'message': 'Groq-Powered API is running',
        'ai_model': 'Groq Llama3-70B',
        'compliance_enforcement': 'Active',
...
def app_info():
    ...
    return jsonify({
        'name': 'Mutual Fund FAQ Assistant API (Groq-Powered)',
        'version': 'v3',
...
def root():
    """Root endpoint."""
    return jsonify({
        'message': 'Mutual Fund FAQ Assistant API (Groq-Powered)',
        'version': 'v3',
        'ai_model': 'Groq Llama3-70B',
        'response_quality': 'AI-Enhanced',
        'compliance_enforcement': 'Active',
...
if __name__ == '__main__':
    print("Starting Groq-Powered Mutual Fund FAQ Assistant API")
    print("Server will be available at: http://localhost:5000")
    print("AI Model: Groq Llama3-70B")
    print("Features:")
