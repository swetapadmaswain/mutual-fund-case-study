...
def check_pipeline_integrity():
    ...
    if phase1_file.exists():
        ...
        checks["issues"].append("Phase 1 results file not found")
        checks["details"]["phase1"] = {"exists": False}
        checks["status"] = "failed"
    ...
    if phase2_1_file.exists():
        ...
        checks["issues"].append("Phase 2.1 results file not found")
        checks["details"]["phase2_1"] = {"exists": False}
        checks["status"] = "failed"
